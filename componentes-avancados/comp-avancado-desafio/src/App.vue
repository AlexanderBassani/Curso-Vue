<template>
	<div id="app">
		...
		<!-- <Vermelho v-if="componente = 'Vermelho'">
			<slot>Conteúdo do Componente <strong>Vermelho</strong></slot>
		</Vermelho>
		<Verde v-else-if="componente = 'Verde'">
			<slot>Conteúdo do Componente <strong>Verde</strong></slot>
		</Verde>
		<Azul v-else>
			<slot> Conteúdo do Componente <strong>Azul</strong></slot>
		</Azul> -->
	</div>
</template>
